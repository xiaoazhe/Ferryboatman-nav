...
(function($) {
  ...
  $(document).on('click', "a[target!='_blank']", function() {
    ...
    if (theme.loading === '1' && $(this).attr('href') && $(this).attr('href').indexOf('#') !== 0 &&
            $(this).attr('href').indexOf('java') !== 0 && !$(this).data('fancybox') &&
            !$(this).data('commentid') && !$(this).hasClass('nofx')) {
  ...
  function stickFooter() {
    ...
    if ($('.main-footer').hasClass('text-xs')) {
      ...
      var main_content_height = $('.main-footer').position().top + footer_height
  ...
  function trigger_resizable(isNoAnim) {
    if ((theme.minNav == '1' && !isMin && $(window).width() > 767.98) || (!isMin && $(window).width() > 767.98 && $(window).width() < 1024)) {
  ...
  function addSite(site, isLive, isHeader) {
    ...
    var url_f
    var matches = site.url.match(/^(?:https?:\/\/)?((?:[-A-Za-z0-9]+\.)+[A-Za-z]{2,6})/)
  ...
  $('.add-custom-site-form').on('submit', function() {
    ...
    $.ajax({
      ...
      .done(function(response) {
        ...
        var url_f
        var matches = url.match(/^(?:https?:\/\/)?((?:[-A-Za-z0-9]+\.)+[A-Za-z]{2,6})/)
  ...
  $(document).on('click', '.hide-type-list .search-group input', function() {
    var parent = $(this).parents('.s-search')
 ...
 */
!(function(e, t) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = t() : typeof define === 'function' && define.amd ? define(t) : (function() {
    const r = e.Base64
    const o = t()
  ...
  'use strict'
  const e = '3.6.0'
  const t = typeof atob === 'function'
  const r = typeof btoa === 'function'
  const o = typeof Buffer === 'function'
  const n = typeof TextDecoder === 'function' ? new TextDecoder() : void 0
  const a = typeof TextEncoder === 'function' ? new TextEncoder() : void 0
  const f = [...'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=']
  const i = (e => {
    const t = {}
    return e.forEach((e, r) => t[e] = r), t
  })(f)
  const c = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/
  const u = String.fromCharCode.bind(String)
  const s = typeof Uint8Array.from === 'function' ? Uint8Array.from.bind(Uint8Array) : (e, t = e => e) => new Uint8Array(Array.prototype.slice.call(e, 0).map(t))
  const d = e => e.replace(/[+\/]/g, e => e == '+' ? '-' : '_').replace(/=+$/m, '')
  const l = e => e.replace(/[^A-Za-z0-9\+\/]/g, '')
  const h = e => {
    let t
    let r
    let o
  ...
  const p = r ? e => btoa(e) : o ? e => Buffer.from(e, 'binary').toString('base64') : h
  const y = o ? e => Buffer.from(e).toString('base64') : e => {
    const t = []
    for (let r = 0, o = e.length; r < o; r += 4096) t.push(u.apply(null, e.subarray(r, r + 4096)))
    return p(t.join(''))
  }
  const A = (e, t = !1) => t ? d(y(e)) : y(e)
  const b = e => {
  ...
  const g = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g
  const B = e => e.replace(g, b)
  const x = o ? e => Buffer.from(e, 'utf8').toString('base64') : a ? e => y(a.encode(e)) : e => p(B(e))
  const C = (e, t = !1) => t ? d(x(e)) : x(e)
  const m = e => C(e, !0)
  const U = /[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g
  const F = e => {
    switch (e.length) {
      case 4:
  ...
  const S = e => {
    ...
    let o
    let n = ''
    for (let a = 0; a < e.length;) t = i[e.charAt(a++)] << 18 | i[e.charAt(a++)] << 12 | (r = i[e.charAt(a++)]) << 6 | (o = i[e.charAt(a++)]), n += r === 64 ? u(t >> 16 & 255) : o === 64 ? u(t >> 16 & 255, t >> 8 & 255) : u(t >> 16 & 255, t >> 8 & 255, 255 & t)
    return n
  }
  const E = t ? e => atob(l(e)) : o ? e => Buffer.from(e, 'base64').toString('binary') : S
  const v = o ? e => s(Buffer.from(e, 'base64')) : e => s(E(e), e => e.charCodeAt(0))
  const D = e => v(z(e))
  const R = o ? e => Buffer.from(e, 'base64').toString('utf8') : n ? e => n.decode(v(e)) : e => w(E(e))
  const z = e => l(e.replace(/[-_]/g, e => e == '-' ? '+' : '/'))
  const T = e => R(z(e))
  const Z = e => ({ value: e, enumerable: !1, writable: !0, configurable: !0 })
  const j = function() {
...
function ChromBookmarkConverter() {
  this.bookmarks = { folders: [] }, this.stripUnneededTags = function(a) {
    ...
    var e = 0
    var f = {}
    var g = { type: 'folder', title: '', add_date: '', last_modified: '', items: [] }
    var h = {}
    var i = $(a)
    var j = !1
    $.each(i.children(), function(a, i) {
      var k, l, m, n, o, p, q, r, s
      e += 1, k = b + '.' + e, j == 1 && i.tagName.toLowerCase() != 'DL'.toLowerCase() && (j = !1, console.log('h3', f), g.items.push(f)), i.tagName.toLowerCase() == 'DL'.toLowerCase() && (g = {
        type: 'folder',
        title: f.title,
        add_date: f.add_date,
        last_modified: f.last_modified,
        items: []
      }, j == 1 && (j = !1), d.bookmarks.folders.push(g), d.processDL(i, k, g)), i.tagName.toLowerCase() == 'H3'.toLowerCase() && (l = $(i), m = l.text() ? l.text() : '未命名', n = l.attr('add_date'), o = l.attr('last_modified'), f = {
        type: 'header',
        title: m,
        add_date: n,
        last_modified: o
      }, j = !0), i.tagName.toLowerCase() == 'a' && isURL($(i).attr('href')) && $(i).text() != '' && (p = $(i), q = p.text(), r = p.attr('href'), s = p.attr('add_date'), p.attr('icon'), h = {
        type: 'link',
        title: q,
        href: r,
        add_date: s
